...
This is mainly used from choice factory contract to create new choice pair. It initializes all swap created parameters which can be updated later with owner key.
